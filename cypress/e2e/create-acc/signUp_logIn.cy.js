describe("Signup Test", () => {
  it.skip("Test valid signup", () => {
    ...
    cy.contains("a", "Not yet a customer?").should("be.visible").click({force:true});
    ...
    cy.contains('Registration completed successfully. You can now log in.').should('be.visible')
  });
